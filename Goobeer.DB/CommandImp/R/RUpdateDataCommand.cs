...
namespace Goobeer.DB.CommandImp.R
{
    ...
    /// update data 命令
    /// </summary>
    public class RUpdateDataCommand : RBaseDataCommand
    {
        public RUpdateDataCommand() { }

        public RUpdateDataCommand(string connectionString, string providerName)
        {
        ...
        public override DbCommand RenderCommandData()
        {
            ...
            sql.AppendFormat("update {0} set ",Data.TableName);
